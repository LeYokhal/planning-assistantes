...
- Cadrage de l'application (v1.10 — 09/09/2026 : périmètre, décisions C2 → C5, journal des briques) : [`docs/PLANNING_ASSISTANTES_CADRAGE.md`](docs/PLANNING_ASSISTANTES_CADRAGE.md)
