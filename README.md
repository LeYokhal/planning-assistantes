...
- Cadrage de l'application (v1.15 — 13/09/2026 : périmètre, décisions C2 → C8, journal des briques) : [`docs/PLANNING_ASSISTANTES_CADRAGE.md`](docs/PLANNING_ASSISTANTES_CADRAGE.md)
